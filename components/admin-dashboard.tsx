...
type DashboardContentProps = {
  owner?: string; // repo owner for GitHubIssues
  repo?: string; // repo name for GitHubIssues
  showWazAlerts?: boolean; // hide WAZ alerts when false
  impersonationControls?: ReactNode; // 👈 header-right slot (View as / Exit buttons)
};
          ...
          <main className="flex-1 space-y-4 p-4 md:p-6">
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                {/* GitHub Issues (already renders a Card) */}
                <GitHubIssues owner={owner} repo={repo} />
              </div>

              {/* Right: Alerts */}
              <div className="space-y-6">
                {/* WAZ Alerts — show for admin view only */}
                {showWazAlerts && (
                  <Card className="border-slate-200">
                    <CardHeader>
                      <div className="flex items-center justify-between">
